package com.wangheart.library.android.widget.divider;
...
public class HorizontalDividerItemDecoration extends FlexibleDividerDecoration {
    private static final String TAG = "HorizontalDividerItem";

    private MarginProvider mMarginProvider;

    private boolean isIgnoreLast = false;
    ...
    public void setIsIgnoreLast(boolean isIgnoreFrist) {
        this.isIgnoreLast = isIgnoreFrist;
    }

    @Override
    protected void setItemOffsets(Rect outRect, int position, RecyclerView parent) {
        if (isIgnoreLast && position == parent.getAdapter().getItemCount() - 1) {
            outRect.set(0, 0, 0, 0);
        } else {
